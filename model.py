...
# 柱端节点
ops.node(1, 0, 0, 0)
ops.node(2, 0, 0, 1500, '-mass', 0.0375, 0.0375, 0, 0, 0, 0)
ops.node(3, 0, 600, 1387.5)
ops.node(4, 0, 600, 1800, '-mass', 2 * 0.0375, 2 * 0.0375, 0, 0, 0, 0)
ops.node(5, 0, 1200, 0)
ops.node(6, 0, 1200, 2100, '-mass', 2 * 0.0375, 2 * 0.0375, 0, 0, 0, 0)
ops.node(7, 0, 1800, 1387.5)
ops.node(8, 0, 1800, 1800, '-mass', 2 * 0.0375, 2 * 0.0375, 0, 0, 0, 0)
ops.node(9, 0, 2400, 0)
ops.node(10, 0, 2400, 1500, '-mass', 0.0375, 0.0375, 0, 0, 0, 0)
# 斗枋节点
...
ops.node(20, 1650, 0, 1500, '-mass', 2 * 0.0375, 2 * 0.0375, 0, 0, 0, 0)
ops.node(21, 1650, 600, 1387.5)
ops.node(22, 1650, 600, 1800, '-mass', 4 * 0.0375, 4 * 0.0375, 0, 0, 0, 0)
ops.node(23, 1650, 1200, 0)
ops.node(24, 1650, 1200, 2100, '-mass', 4 * 0.0375, 4 * 0.0375, 0, 0, 0, 0)
ops.node(25, 1650, 1800, 1387.5)
ops.node(26, 1650, 1800, 1800, '-mass', 4 * 0.0375, 4 * 0.0375, 0, 0, 0, 0)
ops.node(27, 1650, 2400, 0)
ops.node(28, 1650, 2400, 1500, '-mass', 2 * 0.0375, 2 * 0.0375, 0, 0, 0, 0)
# 斗枋节点
...
ops.node(38, 3450, 0, 1500, '-mass', 2 * 0.0375, 2 * 0.0375, 0, 0, 0, 0)
ops.node(39, 3450, 600, 1387.5)
ops.node(40, 3450, 600, 1800, '-mass', 4 * 0.0375, 4 * 0.0375, 0, 0, 0, 0)
ops.node(41, 3450, 1200, 0)
ops.node(42, 3450, 1200, 2100, '-mass', 4 * 0.0375, 4 * 0.0375, 0, 0, 0, 0)
ops.node(43, 3450, 1800, 1387.5)
ops.node(44, 3450, 1800, 1800, '-mass', 4 * 0.0375, 4 * 0.0375, 0, 0, 0, 0)
ops.node(45, 3450, 2400, 0)
ops.node(46, 3450, 2400, 1500, '-mass', 2 * 0.0375, 2 * 0.0375, 0, 0, 0, 0)
# 斗枋节点
...
ops.node(56, 5100, 0, 1500, '-mass', 0.0375, 0.0375, 0, 0, 0, 0)
ops.node(57, 5100, 600, 1387.5)
ops.node(58, 5100, 600, 1800, '-mass', 2 * 0.0375, 2 * 0.0375, 0, 0, 0, 0)
ops.node(59, 5100, 1200, 0)
ops.node(60, 5100, 1200, 2100, '-mass', 2 * 0.0375, 2 * 0.0375, 0, 0, 0, 0)
ops.node(61, 5100, 1800, 1387.5)
ops.node(62, 5100, 1800, 1800, '-mass', 2 * 0.0375, 2 * 0.0375, 0, 0, 0, 0)
ops.node(63, 5100, 2400, 0)
ops.node(64, 5100, 2400, 1500, '-mass', 0.0375, 0.0375, 0, 0, 0, 0)
# 斗枋节点
